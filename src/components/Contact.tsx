...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    window.location.href = `mailto:shriyadwivedi29@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(formData.message)}`;
  };
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "shriyadwivedi29@gmail.com",
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/shriyadwivedi29", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/shriya-dwivedi", label: "LinkedIn" },
      ...
      <div className="max-w-7xl mx-auto">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-white group-hover:text-purple-300 transition-colors text-sm">
                          {info.value}
                        </div>
                      </div>
                    </a>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-purple-600/10 border border-purple-500/30 rounded-xl 
                             ...
                             focus:bg-purple-600/20 transition-all duration-300 backdrop-blur-sm text-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-purple-600/10 border border-purple-500/30 rounded-xl 
                           text-white placeholder-white/50 focus:outline-none focus:border-purple-400 
                           focus:bg-purple-600/20 transition-all duration-300 resize-none backdrop-blur-sm text-sm"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-3 rounded-xl 
                         text-sm font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-3xl p-6 
            ...
            <a 
              href="mailto:shriyadwivedi29@gmail.com"
              className="inline-block bg-white text-[#0a0a0f] px-6 py-2 rounded-full text-sm font-medium 
